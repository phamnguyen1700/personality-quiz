    ...
    <main className="relative z-10 grid min-h-screen place-items-center px-5 py-10 text-white">
      ...
      >
        <img
          src={player.photoUrl}
          alt={player.name}
          className="mx-auto mt-6 h-28 w-28 rounded-[4px] border-2 border-amber-300 object-cover"
        />
        ...
        <p className="mt-4 font-mono text-sm uppercase leading-relaxed text-white/75">
          {player.name} bị dừng ở câu{" "}
          <strong className="text-amber-300">{failedQuestionNumber}</strong>.
        </p>
